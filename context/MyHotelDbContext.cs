...
public class MyHotelDbContext : DbContext
    {
        public static string DbConnectionString = "Server=localhost; Database=MyHotelDb;Persist Security Info=False;User ID=sa;Password=Oluwakayode@12345;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;";
